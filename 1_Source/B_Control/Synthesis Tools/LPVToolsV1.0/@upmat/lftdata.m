...
% LFTDATA   Decomposes a UPMAT.
% 
% [M,DELTA] = lftdata(A) decomposes an uncertain parameter varying matrix
...
% contains only the uncertainties listed in LIST, while M is a UPMAT which 
% retains the others. 
% 
