...
% LPVSPLIT  Extract UPMAT data based on independent variable range
%
% B = LPVSPLIT(A,NAME1,RANGE1,NAME2,RANGE2,....) extracts data from the UPMAT
...
% the UPMAT A on the domain specified by the NAME/INDEX pairs. Each INDEX
...
% from the UPMAT A on the domain specified by the NAME/VALUES pairs. VALUES 
...
% an RGRID object. This extracts data from the UPMAT A based on the
...
% Find locations of NAMEs in the UPMAT list of IVs
...
if niv==0
    ...
    out = upmat(m.DataPrivate(INDEX{:}),rgrid(ivn,ivd,ivrb));
end
