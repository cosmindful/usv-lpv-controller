...
% LPVSPLIT  Extract UPFRD data based on independent variable range
%
% B = LPVSPLIT(A,NAME1,RANGE1,NAME2,RANGE2,....) extracts data from the UPFRD
...
% the UPFRD A on the domain specified by the NAME/INDEX pairs. Each INDEX
...
% from the UPFRD A on the domain specified by the NAME/VALUES pairs. VALUES 
...
% an RGRID object. This extracts data from the UPFRD A based on the
...
% Find locations of NAMEs in the UPFRD list of IVs
...
if niv==0
    ...
    out = upfrd(m.DataPrivate(INDEX{:}),rgrid(ivn,ivd,ivrb));
end
