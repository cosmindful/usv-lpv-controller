...
unsigned int sf_process_check_sum_call( int nlhs, mxArray * plhs[], int nrhs,
  const mxArray * prhs[] )
{
  extern unsigned int sf_Robot_model_LPV_control_process_check_sum_call( int
    nlhs, mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  if (sf_Robot_model_LPV_control_process_check_sum_call(nlhs,plhs,nrhs,prhs))
    return 1;
  return 0;
}
...
{
  extern unsigned int sf_Robot_model_LPV_control_autoinheritance_info( int nlhs,
  ...
  if (strcmp(machineName, "Robot_model_LPV_control") == 0) {
    const mxArray *newRhs[3] = { NULL, NULL, NULL };

    newRhs[0] = prhs[0];
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_Robot_model_LPV_control_autoinheritance_info(nlhs,plhs,3,newRhs);
  }
...
{
  extern unsigned int sf_Robot_model_LPV_control_get_eml_resolved_functions_info
  ...
  if (strcmp(machineName, "Robot_model_LPV_control") == 0) {
    ...
    newRhs[0] = prhs[0];
    newRhs[1] = prhs[2];
    return sf_Robot_model_LPV_control_get_eml_resolved_functions_info(nlhs,plhs,
      2,newRhs);
  }
...
extern unsigned int sf_Robot_model_LPV_control_method_dispatcher(SimStruct *S,
...
unsigned int sf_machine_global_method_dispatcher(SimStruct *simstructPtr, const
  ...
  method, void *data)
{
  if (!strcmp(machineName,"Robot_model_LPV_control")) {
    return(sf_Robot_model_LPV_control_method_dispatcher(simstructPtr,
...
extern void Robot_model_LPV_control_terminator(void);
void sf_machine_global_terminator(void)
{
  if (sfMachineGlobalTerminatorCallable) {
    ...
    Robot_model_LPV_control_terminator();
    sf_debug_terminate();
  }
...
extern void Robot_model_LPV_control_initializer(void);
extern void Robot_model_LPV_control_register_exported_symbols(SimStruct* S);
extern void Robot_model_LPV_control_debug_initialize(void);
void sf_register_machine_exported_symbols(SimStruct* S)
{
  Robot_model_LPV_control_register_exported_symbols(S);
}
...
void sf_machine_global_initializer(SimStruct* S)
{
  ...
  if (sfMachineGlobalInitializerCallable) {
    ...
    if (!simModeIsRTWGen) {
      Robot_model_LPV_control_debug_initialize();
    }

    Robot_model_LPV_control_initializer();
  }
