...
#include "Robot_model_LPV_control_reducedSchedulingOrder_sfun_debug_macros.h"
...
static void initialize_c4_Robot_model_LPV_control_reducedSchedulingOrder
  (SFc4_Robot_model_LPV_control_reducedSchedulingOrderInstanceStruct
   *chartInstance);
static void initialize_params_c4_Robot_model_LPV_control_reducedSchedulingOrder
  (SFc4_Robot_model_LPV_control_reducedSchedulingOrderInstanceStruct
   *chartInstance);
static void enable_c4_Robot_model_LPV_control_reducedSchedulingOrder
  (SFc4_Robot_model_LPV_control_reducedSchedulingOrderInstanceStruct
   *chartInstance);
static void disable_c4_Robot_model_LPV_control_reducedSchedulingOrder
  (SFc4_Robot_model_LPV_control_reducedSchedulingOrderInstanceStruct
   *chartInstance);
static void c4_update_debugger_state_c4_Robot_model_LPV_control_reducedSched
  (SFc4_Robot_model_LPV_control_reducedSchedulingOrderInstanceStruct
   *chartInstance);
static const mxArray
  *get_sim_state_c4_Robot_model_LPV_control_reducedSchedulingOrder
  (SFc4_Robot_model_LPV_control_reducedSchedulingOrderInstanceStruct
   *chartInstance);
static void set_sim_state_c4_Robot_model_LPV_control_reducedSchedulingOrder
  (SFc4_Robot_model_LPV_control_reducedSchedulingOrderInstanceStruct
   *chartInstance, const mxArray *c4_st);
static void finalize_c4_Robot_model_LPV_control_reducedSchedulingOrder
  (SFc4_Robot_model_LPV_control_reducedSchedulingOrderInstanceStruct
   *chartInstance);
static void sf_c4_Robot_model_LPV_control_reducedSchedulingOrder
  (SFc4_Robot_model_LPV_control_reducedSchedulingOrderInstanceStruct
   *chartInstance);
static void c4_chartstep_c4_Robot_model_LPV_control_reducedSchedulingOrder
  (SFc4_Robot_model_LPV_control_reducedSchedulingOrderInstanceStruct
   *chartInstance);
static void initSimStructsc4_Robot_model_LPV_control_reducedSchedulingOrder
  (SFc4_Robot_model_LPV_control_reducedSchedulingOrderInstanceStruct
   *chartInstance);
...
static void c4_emlrt_marshallIn
  (SFc4_Robot_model_LPV_control_reducedSchedulingOrderInstanceStruct
   *chartInstance, const mxArray *c4_Psi, const char_T *c4_identifier, real_T
   c4_y[16]);
...
static void c4_matrix_to_integer_power
  (SFc4_Robot_model_LPV_control_reducedSchedulingOrderInstanceStruct
   *chartInstance, real_T c4_a[16], real_T c4_c[16]);
static void c4_invNxN
  (SFc4_Robot_model_LPV_control_reducedSchedulingOrderInstanceStruct
   *chartInstance, real_T c4_x[16], real_T c4_y[16]);
...
static void c4_eml_xger
   ...
   *chartInstance, int32_T c4_m, int32_T c4_n, real_T c4_alpha1, int32_T c4_ix0,
   int32_T c4_iy0, real_T c4_A[16], int32_T c4_ia0, real_T c4_b_A[16]);
static void c4_eml_xtrsm
  (SFc4_Robot_model_LPV_control_reducedSchedulingOrderInstanceStruct
   *chartInstance, real_T c4_A[16], real_T c4_B[16], real_T c4_b_B[16]);
static real_T c4_norm
  (SFc4_Robot_model_LPV_control_reducedSchedulingOrderInstanceStruct
   *chartInstance, real_T c4_x[16]);
...
static void c4_d_emlrt_marshallIn
  (SFc4_Robot_model_LPV_control_reducedSchedulingOrderInstanceStruct
   *chartInstance, const mxArray *c4_sprintf, const char_T *c4_identifier,
   char_T c4_y[14]);
...
static uint8_T c4_g_emlrt_marshallIn
   ...
   *c4_b_is_active_c4_Robot_model_LPV_control_reducedSchedulingOrder, const
...
static void c4_b_eml_matlab_zgetrf
  (SFc4_Robot_model_LPV_control_reducedSchedulingOrderInstanceStruct
   *chartInstance, real_T c4_A[16], int32_T c4_ipiv[4], int32_T *c4_info);
static void c4_b_eml_xger
  (SFc4_Robot_model_LPV_control_reducedSchedulingOrderInstanceStruct
   *chartInstance, int32_T c4_m, int32_T c4_n, real_T c4_alpha1, int32_T c4_ix0,
   int32_T c4_iy0, real_T c4_A[16], int32_T c4_ia0);
static void c4_b_eml_xtrsm
  (SFc4_Robot_model_LPV_control_reducedSchedulingOrderInstanceStruct
   *chartInstance, real_T c4_A[16], real_T c4_B[16]);
   ...
   *chartInstance)
{
  ...
  chartInstance->c4_is_active_c4_Robot_model_LPV_control_reducedSchedulingOrder =
    0U;
}
   ...
   *chartInstance, const mxArray *c4_st)
{
  ...
  chartInstance->c4_is_active_c4_Robot_model_LPV_control_reducedSchedulingOrder =
    ...
    "is_active_c4_Robot_model_LPV_control_reducedSchedulingOrder");
  sf_mex_destroy(&c4_u);
  c4_update_debugger_state_c4_Robot_model_LPV_control_reducedSched(chartInstance);
   ...
   *chartInstance)
{
  ...
  chartInstance->c4_sfEvent = CALL_EVENT;
  c4_chartstep_c4_Robot_model_LPV_control_reducedSchedulingOrder(chartInstance);
   ...
   char_T *c4_identifier)
{
  ...
  c4_y = c4_h_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c4_b_is_active_c4_Robot_model_LPV_control_reducedSchedulingOrder),
    &c4_thisId);
  sf_mex_destroy
    (&c4_b_is_active_c4_Robot_model_LPV_control_reducedSchedulingOrder);
  return c4_y;
...
/* SFunction Glue Code */
void sf_c4_Robot_model_LPV_control_reducedSchedulingOrder_get_check_sum(mxArray *
  plhs[])
{
...
static const mxArray
  *sf_get_sim_state_info_c4_Robot_model_LPV_control_reducedSchedulingOrder(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"Psi\",},{M[8],M[0],T\"is_active_c4_Robot_model_LPV_control_reducedSchedulingOrder\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c4_Robot_model_LPV_control_reducedSchedulingOrder_get_check_sum(&mxChecksum);
...
static void
  sf_opaque_initialize_c4_Robot_model_LPV_control_reducedSchedulingOrder(void
  *chartInstanceVar)
{
  chart_debug_initialization
    (((SFc4_Robot_model_LPV_control_reducedSchedulingOrderInstanceStruct*)
      chartInstanceVar)->S,0);
  initialize_params_c4_Robot_model_LPV_control_reducedSchedulingOrder
    ((SFc4_Robot_model_LPV_control_reducedSchedulingOrderInstanceStruct*)
     chartInstanceVar);
  initialize_c4_Robot_model_LPV_control_reducedSchedulingOrder
    ((SFc4_Robot_model_LPV_control_reducedSchedulingOrderInstanceStruct*)
     chartInstanceVar);
}

static void sf_opaque_enable_c4_Robot_model_LPV_control_reducedSchedulingOrder
  (void *chartInstanceVar)
{
  enable_c4_Robot_model_LPV_control_reducedSchedulingOrder
    ((SFc4_Robot_model_LPV_control_reducedSchedulingOrderInstanceStruct*)
     chartInstanceVar);
}

static void sf_opaque_disable_c4_Robot_model_LPV_control_reducedSchedulingOrder
  (void *chartInstanceVar)
{
  disable_c4_Robot_model_LPV_control_reducedSchedulingOrder
    ((SFc4_Robot_model_LPV_control_reducedSchedulingOrderInstanceStruct*)
     chartInstanceVar);
}

static void sf_opaque_gateway_c4_Robot_model_LPV_control_reducedSchedulingOrder
  (void *chartInstanceVar)
{
  sf_c4_Robot_model_LPV_control_reducedSchedulingOrder
    ((SFc4_Robot_model_LPV_control_reducedSchedulingOrderInstanceStruct*)
     chartInstanceVar);
}

extern const mxArray*
  sf_internal_get_sim_state_c4_Robot_model_LPV_control_reducedSchedulingOrder
  (SimStruct* S)
{
  ...
  prhs[3] = (mxArray*)
    sf_get_sim_state_info_c4_Robot_model_LPV_control_reducedSchedulingOrder();/* state var info */
...
extern void
  sf_internal_set_sim_state_c4_Robot_model_LPV_control_reducedSchedulingOrder
  (SimStruct* S, const mxArray *st)
{
  ...
  set_sim_state_c4_Robot_model_LPV_control_reducedSchedulingOrder
    ((SFc4_Robot_model_LPV_control_reducedSchedulingOrderInstanceStruct*)
...
static const mxArray*
  sf_opaque_get_sim_state_c4_Robot_model_LPV_control_reducedSchedulingOrder
  (SimStruct* S)
{
  return
    sf_internal_get_sim_state_c4_Robot_model_LPV_control_reducedSchedulingOrder
...
static void
  sf_opaque_set_sim_state_c4_Robot_model_LPV_control_reducedSchedulingOrder
  (SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c4_Robot_model_LPV_control_reducedSchedulingOrder(S,
    st);
}

static void
  sf_opaque_terminate_c4_Robot_model_LPV_control_reducedSchedulingOrder(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    ...
    finalize_c4_Robot_model_LPV_control_reducedSchedulingOrder
      ((SFc4_Robot_model_LPV_control_reducedSchedulingOrderInstanceStruct*)
       chartInstanceVar);
  ...
  unload_Robot_model_LPV_control_reducedSchedulingOrder_optimization_info();
}

static void sf_opaque_init_subchart_simstructs(void *chartInstanceVar)
{
  initSimStructsc4_Robot_model_LPV_control_reducedSchedulingOrder
    ((SFc4_Robot_model_LPV_control_reducedSchedulingOrderInstanceStruct*)
     chartInstanceVar);
}
...
static void
  mdlProcessParameters_c4_Robot_model_LPV_control_reducedSchedulingOrder
  (SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c4_Robot_model_LPV_control_reducedSchedulingOrder
  (SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    mxArray *infoStruct =
      load_Robot_model_LPV_control_reducedSchedulingOrder_optimization_info();
...
static void mdlRTW_c4_Robot_model_LPV_control_reducedSchedulingOrder(SimStruct
  *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c4_Robot_model_LPV_control_reducedSchedulingOrder(SimStruct
  *S)
{
  SFc4_Robot_model_LPV_control_reducedSchedulingOrderInstanceStruct
    *chartInstance;
  chartInstance =
    (SFc4_Robot_model_LPV_control_reducedSchedulingOrderInstanceStruct *)malloc
    (sizeof(SFc4_Robot_model_LPV_control_reducedSchedulingOrderInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c4_Robot_model_LPV_control_reducedSchedulingOrder;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c4_Robot_model_LPV_control_reducedSchedulingOrder;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c4_Robot_model_LPV_control_reducedSchedulingOrder;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c4_Robot_model_LPV_control_reducedSchedulingOrder;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c4_Robot_model_LPV_control_reducedSchedulingOrder;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c4_Robot_model_LPV_control_reducedSchedulingOrder;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c4_Robot_model_LPV_control_reducedSchedulingOrder;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c4_Robot_model_LPV_control_reducedSchedulingOrder;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW =
    mdlRTW_c4_Robot_model_LPV_control_reducedSchedulingOrder;
  chartInstance->chartInfo.mdlStart =
    mdlStart_c4_Robot_model_LPV_control_reducedSchedulingOrder;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c4_Robot_model_LPV_control_reducedSchedulingOrder;
...
void c4_Robot_model_LPV_control_reducedSchedulingOrder_method_dispatcher
  (SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c4_Robot_model_LPV_control_reducedSchedulingOrder(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c4_Robot_model_LPV_control_reducedSchedulingOrder(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c4_Robot_model_LPV_control_reducedSchedulingOrder(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c4_Robot_model_LPV_control_reducedSchedulingOrder_method_dispatcher.\n"
