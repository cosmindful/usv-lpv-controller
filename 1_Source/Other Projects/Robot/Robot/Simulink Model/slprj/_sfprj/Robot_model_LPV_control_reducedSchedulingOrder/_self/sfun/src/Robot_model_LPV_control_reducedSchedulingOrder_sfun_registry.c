...
{
  extern unsigned int
    sf_Robot_model_LPV_control_reducedSchedulingOrder_process_check_sum_call
    ( int nlhs, mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  if (sf_Robot_model_LPV_control_reducedSchedulingOrder_process_check_sum_call
      (nlhs,plhs,nrhs,prhs))
    return 1;
  return 0;
}
  ...
  nrhs, const mxArray * prhs[] )
{
  ...
  if (strcmp(machineName, "Robot_model_LPV_control_reducedSchedulingOrder") == 0)
  {
    ...
    newRhs[2] = prhs[3];
    return
      sf_Robot_model_LPV_control_reducedSchedulingOrder_autoinheritance_info
      (nlhs,plhs,3,newRhs);
  }
...
extern unsigned int
  sf_Robot_model_LPV_control_reducedSchedulingOrder_method_dispatcher(SimStruct *
...
unsigned int sf_machine_global_method_dispatcher(SimStruct *simstructPtr, const
  ...
  method, void *data)
{
  if (!strcmp(machineName,"Robot_model_LPV_control_reducedSchedulingOrder")) {
    return(sf_Robot_model_LPV_control_reducedSchedulingOrder_method_dispatcher
...
extern void Robot_model_LPV_control_reducedSchedulingOrder_terminator(void);
void sf_machine_global_terminator(void)
{
  if (sfMachineGlobalTerminatorCallable) {
    ...
    Robot_model_LPV_control_reducedSchedulingOrder_terminator();
    sf_debug_terminate();
  }
...
extern void Robot_model_LPV_control_reducedSchedulingOrder_initializer(void);
extern void
  Robot_model_LPV_control_reducedSchedulingOrder_register_exported_symbols
  (SimStruct* S);
extern void Robot_model_LPV_control_reducedSchedulingOrder_debug_initialize(void);
void sf_register_machine_exported_symbols(SimStruct* S)
{
  Robot_model_LPV_control_reducedSchedulingOrder_register_exported_symbols(S);
}
...
void sf_machine_global_initializer(SimStruct* S)
{
  ...
  if (sfMachineGlobalInitializerCallable) {
    ...
    if (!simModeIsRTWGen) {
      Robot_model_LPV_control_reducedSchedulingOrder_debug_initialize();
    }

    Robot_model_LPV_control_reducedSchedulingOrder_initializer();
  }
