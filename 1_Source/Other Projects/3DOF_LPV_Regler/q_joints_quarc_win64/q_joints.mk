...
MODEL                = q_joints
MODULES              = q_joints_data.c q_joints_main.c rt_zcfcn.c 
MAKEFILE             = q_joints.mk
...
MODELLIB                  = q_jointslib.lib
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = q_joints_ref.rsp
MODELREF_INC_PATH         = 
...
START_DIR         = D:\EIGENE~1\MATLAB\3DOF_L~1
MASTER_ANCHOR_DIR = 
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)\q_joints_quarc_win64
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)
MATLAB_INCLUDES = $(MATLAB_INCLUDES);D:\Desktop\MINIMA~1
