%% Design an LPV State Model and synthesize LFT-LPV Controller
% -------------------------------------------------------------------------
% script   : generalizedPlant_3DOF.m
% -------------------------------------------------------------------------
% Author   : Christian Hoffmann (edited by Michael Garstka)
...
% 
%
% This function generates a generalized plant based on the input plant in
% uss form and by choosing suitable weighting filters.
% It outputs the generalized plant PLFR
...
% add the uncertainty back in to create uss
...
dWk2  = c2d(Wk2 , 0.001, 'tustin');
dWk3  = c2d(Wk3 , 0.001, 'tustin');

figure(35);
sigma(1/dWs1,'b', 1/dWs2,'b', 1/dWs3,'b', 1/dWk1,'r', 1/dWk2,'r', 1/dWk3,'r')
